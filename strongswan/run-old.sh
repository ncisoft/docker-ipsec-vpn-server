...
L2TP_NET=${VPN_L2TP_NET:-'192.168.100.0/24'}
L2TP_LOCAL=${VPN_L2TP_LOCAL:-'192.168.100.1'}
L2TP_POOL=${VPN_L2TP_POOL:-'192.168.100.10-192.168.100.250'}
XAUTH_NET=${VPN_XAUTH_NET:-'192.168.43.0/24'}
XAUTH_POOL=${VPN_XAUTH_POOL:-'192.168.100.10-192.168.100.250'}
...
conn shared
  ...
  #ike=aes128-sha1-modp2048,aes128-sha1-modp1024,3des-sha1-modp1024,3des-sha1-modp1536,aes256-sha2,aes128-sha2,aes256-sha1,aes128-sha1,aes256-sha2;modp1024,aes128-sha1;modp1024
...
ios:$addl_password_enc:xauth-psk
EOF
    count=$((count+1))
